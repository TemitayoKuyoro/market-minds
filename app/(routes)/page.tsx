    ...
    <>
      <section className="mt-10">
        <Container>
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 sm:gap-14">
            <div>
              <h1 className="font-black text-5xl tracking-tight leading-tighter">
                Unlock Your Digital Success with Us!
              </h1>
              <p className="text-xl font-light mt-8 tracking-wide leading-snug">
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 sm:gap-14 mt-6">
            <div className="grid grid-cols-2 gap-2">
              <div className="flex flex-col items-center py-6 px-2.5 border rounded">
            ...
            <p className="text-xl font-light tracking-wide leading-snug">
              &rdquo;Thanks to their expertise, we witnessed a remarkable surge
              in our online presence, and our brand is now thriving like never
      ...
      <section className="mt-24">
        <Container>
          ...
          <div className="flex gap-8 py-4 mt-6">
            <Image
              width="50"
              height="50"
      ...
      <section className="mt-20 py-6">
        <Container>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 mt-6 justify-between">
            <div
              className="grid grid-cols-1"
              style={{
                gridTemplateRows: " 30vh 70px auto",
              }}
            >
              <div
              ...
              <h3 className="font-semibold text-2xl self-center">
                Co-founder & CEO
              </h3>
              <p className="text-xl font-light tracking-wide leading-snug">
            ...
            >
              ...
              <h3 className="font-semibold text-2xl self-center leading-none">
                Lead Marketing Strategist
              </h3>
              <p className="text-xl font-light tracking-wide leading-tight">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
              <div>
                <p className="text-xl font-light tracking-wide leading-tight">
                  ...
                  and we&apos;ve seen a remarkable increase in qualified leads.
                  Market Minds has truly been a trusted partner in our growth
                  journey.
                </p>
              </div>
              <div>
                <p className="text-xl font-light tracking-wide leading-tight">
                  We&apos;ve been with Market Minds for several years, and their
                  dedication to our success has been unwavering. Their ability
                  to adapt to the ever-changing digital landscape while
                  maintaining a data-driven approach has been instrumental in
                  our growth. Whether it&apos;s optimizing our website, managing
                  our PPC campaigns, or crafting engaging content, Market Minds
                  consistently delivers results. They&apos;ve not just met but
                  exceeded our digital marketing expectations.
                </p>
              </div>
              <div>
                <p className="text-xl font-light tracking-wide leading-tight">
                  We&apos;ve been collaborating with Market Minds for over a
                  year, and the results have been exceptional. Their data-driven
                  approach to PPC advertising has significantly reduced our ad
                  spend while increasing conversions. The dedication to our
                  goals and transparent communication has made Market Minds an
                  invaluable extension of our marketing team.
                </p>
              </div>
              <div>
                <p className="text-xl font-light tracking-wide leading-tight">
                  ...
                  boutique&apos;s online visibility and brand recognition. Their
                  tailored content strategies and social media management have
                  not only increased our followers but also driven sales like
                  never before. Market Minds is a top-notch team dedicated to
                  delivering results.
                </p>
              </div>
            </div>
